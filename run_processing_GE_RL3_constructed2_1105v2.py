...
def main(task):
    ...
    py_file_list = ['average_statistics_GE_RL3_constructed2_1105v2.py','main_pipeline_GE_RL3_constructed2_1105v2.py','main_pipeline_GE_RL3_constructed2_1105v2_single_test.py', \
                    'mapcompare_GE_RL3_constructed2_1105v2.py','mapcompare_GE_RL3_constructed2_1105v2_single_test.py']
    ...
    if task == 'test':
        python_script = "main_pipeline_GE_RL3_constructed2_1105v2_single_test.py"  # 替换为你要运行的 Python 脚本名
        print(f"运行 Python 脚本: {python_script}")
        subprocess.run(["python", python_script], check=True)

    else:
        # 第三步：运行指定的 Python 脚本
        python_script = "main_pipeline_GE_RL3_constructed2_1105v2.py"  # 替换为你要运行的 Python 脚本名
        print(f"运行 Python 脚本: {python_script}")
        subprocess.run(["python", python_script], check=True)
